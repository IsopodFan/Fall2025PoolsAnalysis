...
description of files: - ExampleAfiles, ExampleBfiles, ExampleCfiles - each of these are examples provided by the Geange paper on how to use their analysis technique
...
Output files: the output files are currently unorganized and lack a good naming scheme. This will be fixed later but for now I'll simply describe them here:
